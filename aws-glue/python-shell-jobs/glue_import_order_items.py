...
if __name__ == "__main__":
    ...
    merge_query = """
        BEGIN;
            ...
            COPY mysql_dwh_staging.order_items 
            FROM 's3://mysql-dwh-serhii/order_items/current/order_items.csv'
            ...
            USING
                mysql_dwh_staging.order_items
            WHERE 
                mysql_dwh.order_items.order_id = mysql_dwh_staging.order_items.order_id;
